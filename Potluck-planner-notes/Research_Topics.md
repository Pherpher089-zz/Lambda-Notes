...
- `immediate`
Write log line on request instead of response. This means that a request will be logged even if the server crashes, *but data from the responcse(like the response code, content lnegth, ect) can not be logged.*
